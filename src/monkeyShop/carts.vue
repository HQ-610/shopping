<template>
	<div>
							...
							<li v-for="(item,index) in cartList">
								<div class="cart-tab-1">
									<div class="cart-item-check">
										<a class="checkbox-btn item-check-btn" v-bind:class="{'check':item.checked==1}" @click="edit('check',item)">
								...
								<div class="cart-tab-5 ">
									<div class="cart-item-opration ">
										<a class="item-edit-btn " @click="delCart(item.productId)">
					...
					<div class="cart-foot-inner ">
                      ...
                      <svg class="icon icon-ok">
						...
						<div class="cart-foot-r ">
							...
							<div class="btn-wrap ">
								<a class="btn btn--red " v-bind:class="{'btn--dis':checkCount==0}" @click="toAddress">Checkout</a>
							</div>
						</div>
					</div>
				</div>
		...
		<model v-bind:mdShow="deleCart" v-on:close="closeCart">
			<p slot="message">
				您确定要删除这个商品吗？
			</p>
			<div slot="btnGroup">
				<a class="btn btn--m" @click="delCartConfirm">确认</a>
				<a href="javascipt:;" class="btn btn--m" @click="deleCart=false">取消</a>
			</div>
		</model>
